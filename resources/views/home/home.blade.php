        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Bagi kamu yang memiliki usaha minimal 3 tahun berjalannya perusahaan agar dapat mengajukan pengajuan</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Untuk rekening perusahaan wajib teripisah dengan rekening pribadi, dan untuk bank wajib sudah terdaftar BUMN</p>
            </div>
          </div>
